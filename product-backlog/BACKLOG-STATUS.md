...
| US-06-05 | UIA Text Extraction (Teams Captions) | P2 | 🔵 Built | 5 | TeamsCaptionsReader polls Teams window via UIAutomation (AutomationId/ClassName/Name "caption" search, depth-8 tree walk, 500ms interval); CaptionLineReceived feeds transcript buffer |
...
**Epic 06 Total:** 30 SP · 0 Done · 30 Built · 0 Scaffolded · 0 Yet to Start
...
| US-09-07 | Platform Compatibility Testing Matrix | P3 | 🔵 Built | 3 | PLATFORM-COMPAT-TEST-MATRIX.md — 10-section test matrix, regression checklist, bug labels |

**Epic 09 Total:** 27 SP · 0 Done · 19 Built · 0 Scaffolded · 8 Yet to Start
