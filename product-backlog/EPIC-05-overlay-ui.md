...
|----------|-------|----------|--------|----|
| US-05-01 | Transparent Always-on-Top Window | P0 — MVP | 🔴 Yet to Start | 5 |
| US-05-02 | Response Display Panel | P0 — MVP | 🔴 Yet to Start | 8 |
| US-05-03 | Live Transcript Strip | P2 — Medium | 🔴 Yet to Start | 5 |
| US-05-04 | Status Indicators | P1 — High | 🔴 Yet to Start | 3 |
| US-05-05 | System Tray Integration | P1 — High | 🔴 Yet to Start | 5 |
| US-05-06 | Overlay Theme & Opacity Config | P2 — Medium | 🔴 Yet to Start | 3 |
| US-05-07 | Auto-hide During Screen Share | P1 — High | 🔴 Yet to Start | 8 |
| US-05-08 | Multi-monitor Support | P2 — Medium | 🔴 Yet to Start | 3 |
| US-05-09 | Response Copy & Share | P2 — Medium | 🔴 Yet to Start | 2 |
